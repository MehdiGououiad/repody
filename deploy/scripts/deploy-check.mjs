...
const steps = [
  ...
  [
    "node-check-client-integration",
    "node",
    ["--check", "deploy/scripts/client-integration-check.mjs"],
  ],
  ["node-check-prod-readiness", "node", ["--check", "deploy/scripts/prod-readiness-check.mjs"]],
  ["node-check-extract-soak", "node", ["--check", "deploy/scripts/extract-soak.mjs"]],
  ...
  [
    "node-check-release-supply-chain",
    "node",
    ["--check", "deploy/scripts/release-supply-chain.mjs"],
  ],
