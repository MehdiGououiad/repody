...
| **Local dev** | Docker Compose (`pnpm platform`) | Fast daily iteration |
| **Production cluster** | Helm (+ optional Argo CD) on OpenShift / K8s | Same charts clients receive — [OPENSHIFT.md](../deploy/OPENSHIFT.md) |
