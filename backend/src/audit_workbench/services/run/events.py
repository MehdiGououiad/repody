"""Publish run domain events to queue refresh, SSE, and progress infrastructure."""
...
from audit_workbench.services.run.progress import fail_run_progress
...
async def _on_run_completed(event: RunCompleted) -> None:
    from audit_workbench.services.run.sse import publish_run_terminal
