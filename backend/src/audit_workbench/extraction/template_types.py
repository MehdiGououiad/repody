"""Infer NuExtract leaf template types from field names and descriptions."""
...
def suggest_template_type(name: str, description: str = "") -> str:
    ...
    return (
        _with_list_suffix(DEFAULT_NUEXTRACT_TEMPLATE_TYPE)
        if wants_list
        else DEFAULT_NUEXTRACT_TEMPLATE_TYPE
    )
