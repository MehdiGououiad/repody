...
async def lifespan(app: FastAPI):
    ...
    if settings.oidc_enabled:
        from repody.infra.auth.jwt_validator import warm_jwks_cache
    ...
    from repody.app.ops.maintenance import maintenance_loop, run_maintenance_cycle
