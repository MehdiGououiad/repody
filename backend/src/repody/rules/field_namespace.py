"""Evaluator field namespace — shared by rules runner and IDP validate."""

from __future__ import annotations

from repody.rules.types import rule_applies_to
...
def field_values_from_extractions(
    ...
    *,
    ...
    """Build evaluator namespace from extracted rows (key, value, document_type)."""
    values: dict[str, str] = {}
