...
from audit_workbench.services.run.progress import (
    _last_progress_commit,
    set_run_progress,
)
from audit_workbench.services.run.progress import _step, build_run_progress_plan
...
async def test_progress_sse_published_even_when_db_throttled(monkeypatch):
    ...
    monkeypatch.setattr("audit_workbench.services.run.sse.publish_run_progress", _publish)
    monkeypatch.setattr("audit_workbench.db.base.async_session_factory", _session_factory)
    monkeypatch.setattr(
        "audit_workbench.services.run.progress.get_settings",
