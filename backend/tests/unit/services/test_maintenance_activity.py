...
from audit_workbench.services.maintenance import _running_activity_at, maybe_reap_stale_run
...
async def test_maybe_reap_stale_run_uses_activity_clock(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("audit_workbench.services.maintenance.fail_run_terminal", fail)
    monkeypatch.setattr(
