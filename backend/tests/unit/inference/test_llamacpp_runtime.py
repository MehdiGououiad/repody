...
from repody.catalog.registry import _registered_models, parse_document_model
...
def test_llamacpp_base_url():
    ...
    from repody.inference.runtime import DOCUMENT_RUNTIME, llamacpp_base_url
...
def test_top_k_is_sent_as_openai_extra_body():
    from repody.inference.openai_compat import split_chat_payload
